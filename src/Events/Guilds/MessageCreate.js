    ...
    async callback(message) {
        ...
        if (get) {
            ...
            try {
                ...
                this.client.whandler.sendWebhook(this.client.config.webhook.error, {
                    embeds: [this.client.ehandler.custom().setColor(this.client.config.colors.failed).setDescription(`**Command Error:**\n\n${err.stack || err}`)]
                })
            }
        }
    }
